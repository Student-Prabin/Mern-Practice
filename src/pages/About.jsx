  ...
  return (
    <>
      <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-4 w-[80vw] m-auto">
        <img className="max-sm:hidden" src="https://www.w3schools.com/w3images/tablesetting2.jpg" alt="burger" />

        <div className="flex flex-col items-center  p-4 gap-7">
          <h1 className="text-4xl">About Catering</h1>
          <p className="text-xl">Tradition since 1889</p>
